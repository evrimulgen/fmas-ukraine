object FormPrK_Zach_Rules_Edit: TFormPrK_Zach_Rules_Edit
  Left = 374
  Top = 191
  BorderStyle = bsDialog
  Caption = 'FormPrK_Zach_Rules_Edit'
  ClientHeight = 273
  ClientWidth = 331
  Color = clBtnFace
  ...
  object cxButtonEditPreim: TcxButtonEdit
    Left = 26
    Top = 34
    Width = 290
    Height = 21
    ...
    Properties.OnButtonClick = cxButtonEditPreimPropertiesButtonClick
    ...
    Style.Font.Style = [fsBold]
    TabOrder = 0
    Text = 'cxButtonEditPreim'
  end
  object cxSpinEditORDER_ZACH: TcxSpinEdit
    Left = 216
    Top = 161
    Width = 100
    Height = 21
  ...
  object cxLabelORDER_ZACH: TcxLabel
    Left = 16
    Top = 162
    Width = 193
    Height = 19
    ...
    Style.Shadow = False
    TabOrder = 8
    Caption = 'cxLabelORDER_ZACH'
  end
  object cxLabelIS_ZACH_RULE: TcxLabel
    Left = 56
    Top = 188
    Width = 257
    Height = 19
  ...
  object cxCheckBoxIIS_ZACH_RULE: TcxCheckBox
    Left = 26
    Top = 188
    Width = 30
    Height = 21
  ...
  object cxLabelKAT_PRI_D: TcxLabel
    Left = 16
    Top = 55
    Width = 274
    Height = 19
  ...
  object cxButtonEditKAT_PRI_D: TcxButtonEdit
    Left = 26
    Top = 79
    Width = 290
    Height = 21
    ...
    Properties.ReadOnly = True
    Properties.OnButtonClick = cxButtonEditKAT_PRI_DPropertiesButtonClick
    Style.Color = 16776176
    Style.Font.Charset = DEFAULT_CHARSET
    Style.Font.Color = clWindowText
    Style.Font.Height = -11
    ...
    Style.Font.Style = [fsBold]
    TabOrder = 1
    Text = 'cxButtonEditKAT_PRI_D'
  end
  object cxLabelNOMER_PRAVIL: TcxLabel
    Left = 16
    Top = 104
    Width = 249
    Height = 19
  ...
  object cxTextEditNOMER_PRAVIL: TcxTextEdit
    Left = 26
    Top = 128
    Width = 290
    Height = 25
