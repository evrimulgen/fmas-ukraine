...
uses PlaceMissionForm, Dialogs, SysUtils, Forms;
...
var
    T : TfmPlaceMissionForm;
begin
        T := TfmPlaceMissionForm.Create(Owner, Self, Class_Database.Handle, Class_Transaction_R.Handle, SpEdit);
        T.ShowModal;
...
begin
    if SpEdit=true then
    begin
        T := TfmPlaceMissionForm.Create(Owner, Self, Class_Database.Handle, Class_Transaction_R.Handle, Edit);
        T.FormStyle := fsMDIChild;
        T.Show;
    end
    else
    begin
        T := TfmPlaceMissionForm.Create(Owner, Self, Class_Database.Handle, Class_Transaction_R.Handle, Sp);
        T.ShowModal;
        ShowForm:=T.ResValue;
        T.Free;
    end;
