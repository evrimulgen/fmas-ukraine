...
{  if not Is_Admin then
  ...
  if ViewForm.ModalResult = mrOK then
   begin
    ...
    DM.StoredProc.ParamByName('TARIF_NON_NDS').AsFloat     := ViewForm.CurrencyEdit_headcound.EditValue;
    DM.StoredProc.ExecProc;
 ...
 { if not Is_Admin then
  ...
  If  ViewForm.ModalResult = mrOK then
   begin
    ...
    DM.StoredProc.ParamByName('TARIF').Asfloat      := ViewForm.CurrencyEdit_tarif.EditValue;
    DM.StoredProc.ParamByName('HEADCOUNT').Asfloat  := ViewForm.CurrencyEdit_headcound.EditValue;
    DM.StoredProc.ParamByName('TARIF_NON_NDS').Asfloat  := ViewForm.CurrencyEdit_tarif_NON_NDS.EditValue;
    DM.StoredProc.ExecProc;
