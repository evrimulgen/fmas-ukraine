object frm_price_DM: Tfrm_price_DM
  ...
  object MemoryData_services: TRxMemoryData
    ...
    object MemoryData_servicesMemoryData_date_beg: TDateField
      FieldName = 'MemoryData_date_beg'
    end
    object MemoryData_servicesMemoryData_date_end: TDateField
      FieldName = 'MemoryData_date_end'
    end
  end
end
