...
begin
  ...
  ViewForm.DATE_BEG_PR := DATE_BEG_PRICE;//DM.DataSet_main['Date_beg'];
  ViewForm.DATE_END_PR := DATE_END_PRICE;//DM.DataSet_main['date_END'];
   ...
   Begin
    ...
    for i := 0 to ViewForm.DM.MemoryData_services.RecordCount - 1 do
     Begin
      ...
      DM.StoredProc.ParamByName('DATE_BEG').AsDate        := ViewForm.DM.MemoryData_services['MemoryData_date_beg'];
      DM.StoredProc.ParamByName('DATE_END').AsDate        := ViewForm.DM.MemoryData_services['MemoryData_date_end'];
      DM.StoredProc.ParamByName('TARIF').AsDouble           := ViewForm.DM.MemoryData_services['MemoryData_tariff'];
      DM.StoredProc.ParamByName('NORMA').AsDouble           := ViewForm.DM.MemoryData_services['MemoryData_norma'];
      DM.StoredProc.ParamByName('SUMMA').AsDouble           := ViewForm.DM.MemoryData_services['MemoryData_summa'];
...
begin
  ...
  ViewForm.DATE_BEG_PR := DATE_BEG_PRICE;
  ViewForm.DATE_END_PR := DATE_END_PRICE;
  ...
  ViewForm.id_price_param                     := id_price_param;
  ...
  For i := 0 to DM.DataSet_read.RecordCount - 1 do
   Begin
    ...
    //ViewForm.DM.MemoryData_services['MemoryData_date_beg']  := DM.DataSet_main['DATE_BEG_kat'];
    //ViewForm.DM.MemoryData_services['MemoryData_date_end']  := DM.DataSet_main['DATE_END_kat'];
    ViewForm.DM.MemoryData_services['MemoryData_date_beg']    := DM.DataSet_read['DATE_BEG'];
    ViewForm.DM.MemoryData_services['MemoryData_date_end']    := DM.DataSet_read['DATE_END'];
    ViewForm.DM.MemoryData_services['MemoryData_tariff']      := DM.DataSet_read['TARIF'];
    ViewForm.DM.MemoryData_services['MemoryData_norma']       := DM.DataSet_read['NORMA'];
  //  ViewForm.DM.MemoryData_services['MemoryData_norma']       :=formatfloat('0.00', ViewForm.DM.MemoryData_services['MemoryData_norma']);
    ViewForm.DM.MemoryData_services['MemoryData_summa']       := DM.DataSet_read['SUMMA'];

    //ViewForm.DATE_BEG_PR := DM.DataSet_main['DATE_BEG_kat'];
   // ViewForm.DATE_END_PR := DM.DataSet_main['DATE_END_kat'];
