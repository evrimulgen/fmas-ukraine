object fmSpKat: TfmSpKat
  ...
  object cxGridShowKat: TcxGrid
    ...
    ParentFont = False
    TabOrder = 0
    OnDblClick = cxGridShowKatDblClick
    object cxGridShowKatDBTableView1: TcxGridDBTableView
      OnDblClick = cxGridShowKatDBTableView1DblClick
      DataController.DataSource = DataSourceSelectionKat
      ...
      object cxGridShowKatDBTableView1DBColumn1: TcxGridDBColumn
    ...
    object cxGridShowKatLevel1: TcxGridLevel
      GridView = cxGridShowKatDBTableView1
    end
  end
  object pFIBDatabaseSpKat: TpFIBDatabase
  ...
  object pFIBDataSetSpSelKat: TpFIBDataSet
    Database = pFIBDatabaseSpKat
    Transaction = pFIBTransactionRead
    SelectSQL.Strings = (
      'select * from CN_SP_KAT_STUD'
      'order by name collate win1251_UA')
    Left = 64
    Top = 24
    poSQLINT64ToBCD = True
    object pFIBDataSetSpSelKatID_KAT_STUD: TFIBBCDField
      FieldName = 'ID_KAT_STUD'
      Size = 0
      RoundByScale = True
    end
    object pFIBDataSetSpSelKatNAME: TFIBStringField
      FieldName = 'NAME'
      Size = 40
      EmptyStrToNull = True
    end
    object pFIBDataSetSpSelKatSHORT_NAME: TFIBStringField
      FieldName = 'SHORT_NAME'
      Size = 10
      EmptyStrToNull = True
    end
  end
  object DataSourceSelectionKat: TDataSource
    DataSet = pFIBDataSetSpSelKat
    Left = 64
    Top = 56
  end
  object pFIBTransactionRead: TpFIBTransaction
    DefaultDatabase = pFIBDatabaseSpKat
