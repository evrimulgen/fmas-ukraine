...
begin
   ...
   cxGrid2TableView1Column4.DataBinding.ValueTypeClass := TcxIntegerValueType;
...
begin
  ...
  begin
    ...
    cxGrid2TableView1Column4.DataBinding.DataController.Values[i, 27] := DataSet.FBN('IS_INFO_PRO_OBM').AsInteger;
    DataSet.Next;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      (Owner as TfrmReeFnzb).StoredProc.ParamByName('IS_INFO_PRO_OBM').AsInteger := cxGrid2TableView1Column4.DataBinding.DataController.Values[i, 27];
