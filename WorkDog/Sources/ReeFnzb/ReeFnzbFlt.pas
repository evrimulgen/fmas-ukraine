...
type
  TFnzbFormFlt = class(TForm)
    ...
    procedure cxCheckBoxNumDogClick(Sender: TObject);
  private
...
begin
  ...
  NumEdit.Text:='';
  cxTextEditNumDog.Enabled:=False;
  cxTextEditNumDog.Text:='';
end;
...
procedure TFnzbFormFlt.cxCheckBoxNumDogClick(Sender: TObject);
begin
begin
  cxTextEditNumDog.Enabled:=cxCheckBoxNumDog.Checked;
